...
export const sortCharacter = function (character) {
    ...
    return sortObjectKeys(character, 'name', 'characterClass', 'gender', 'icon', 'iconUrl', 'thumbnail', 'thumbnailUrl', 'noThumbnail', 'edition', 'identities', 'tokens', 'primaryToken', 'handSize', 'unlockEvent', 'retireEvent', 'traits', 'color', 'spoiler', 'specialTags', 'locked', 'marker', 'deck', 'stats', 'summon', 'characterClass', 'availableSummons', 'perks', 'masteries', 'additionalModifier');
}