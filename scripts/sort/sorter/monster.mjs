...
export const sortMonster = function (monster) {
  ...
  return sortObjectKeys(monster, 'name', 'thumbnail', 'edition', 'deck', 'boss', 'flying', 'catching', 'hidden', 'count', 'standeeCount', 'standeeShare', 'standeeShareEdition', 'baseStat', 'stats');
}