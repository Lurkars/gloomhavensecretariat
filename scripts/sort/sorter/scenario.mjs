...
export const sortScenario = function (scenario) {
    ...
    return sortObjectKeys(scenario, 'index', 'group', 'name', 'gridLocation', 'coordinates', 'edition', 'parent', 'parentSections', 'conclusion', 'named', 'blockedSections', 'marker', 'spoiler', 'initial', 'random', 'solo', 'allyDeck', 'resetRound', 'unlocks', 'requires', 'requirements', 'blocks', 'links', "forcedLinks", "rewards", 'monsters', 'allies', 'allied', 'drawExtra', 'objectives', 'lootDeckConfig', 'rules', 'rooms', 'complexity');
}