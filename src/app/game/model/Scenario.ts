...
export class Scenario extends ScenarioData {
  ...
  constructor(scenarioData: ScenarioData, revealedRooms: number[] = [], custom: boolean = false) {
    super(scenarioData.name, scenarioData.index, scenarioData.unlocks, scenarioData.blocks, scenarioData.requires, scenarioData.links, scenarioData.monsters, scenarioData.allies, scenarioData.objectives, scenarioData.rooms, scenarioData.marker, scenarioData.rules, scenarioData.edition, scenarioData.group, scenarioData.spoiler, scenarioData.allyDeck);
