...
export enum EventCardConditionType {
    ...
    reputationDemonsGT = "reputationDemonsGT",
    reputationMilitaryGT = "reputationMilitaryGT",
    reputationMerchantsGuildGT = "reputationMerchantsGuildGT",
...
export enum EventCardEffectType {
    ...
    consumeCollectiveItemChoose = "consumeCollectiveItemChoose",
    custom = "custom",
    discard = "discard",
    ...
    loseReputationDemons = "loseReputationDemons",
    loseReputationMilitary = "loseReputationMilitary",
    loseReputationMerchantsGuild = "loseReputationMerchantsGuild",
    loseResource = "loseResource",
    loseTrait = "loseTrait",
    morale = "morale",
    noEffect = "noEffect",
    ...
    reputationDemons = "reputationDemons",
    reputationMilitary = "reputationMilitary",
    reputationMerchantsGuild = "reputationMerchantsGuild",
