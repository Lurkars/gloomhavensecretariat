...
export class HealthHelper {
  ...
  toggleDeadExhausted() {
    this.component.before(this.component.entity instanceof Character ? (this.component.entity.exhausted ? 'notExhausted' : 'exhausted') : 'dead');
    ...
    if (this.component.entity instanceof Character) {
      ...
      setTimeout(() => {
        this.component.entities.forEach((entity) => {
          ...
          if ((figure instanceof Monster || figure instanceof ObjectiveContainer) && figure.active && figure.entities.every((entity) => !gameManager.entityManager.isAlive(entity))) {
  ...
  changeHealth(value: number) {
    ...
    if (!!this.component.entity) {
      ...
      if (this.component.entity instanceof Character && this.component.entity.name == 'lightning' && this.component.specialTags.includes('unbridled-power')) {
