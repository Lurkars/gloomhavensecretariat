import {t}from'./chunk-zMLjRSTw.js';import {e as ea,o as oa,r as ra,i as ia,b as aa,s as sa,a as o,c as ct,_ as _o,q as ft,Z as a,a0 as yr,a1 as $c,a2 as ze,X as Xs,t as ta,a3 as Ic,B as Bs}from'./chunk-BTmp_2cW.js';import {d}from'./chunk-BXeFvLfe.js';import'./main-MLTV4FX6.js';var lt=Bs.pie,L={sections:new Map,showData:false},b=L.sections,O=L.showData,St=structuredClone(lt),xt=o(()=>structuredClone(St),"getConfig"),wt=o(()=>{b=new Map,O=L.showData,ta();},"clear"),Ct=o(({label:t,value:a})=>{if(a<0)throw new Error(`"${t}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);b.has(t)||(b.set(t,a),ct.debug(`added new section: ${t}, with value: ${a}`));},"addSection"),$t=o(()=>b,"getSections"),Dt=o(t=>{O=t;},"setShowData"),yt=o(()=>O,"getShowData"),st={getConfig:xt,clear:wt,setDiagramTitle:sa,getDiagramTitle:aa,setAccTitle:ia,getAccTitle:ra,setAccDescription:oa,getAccDescription:ea,addSection:Ct,getSections:$t,setShowData:Dt,getShowData:yt},Tt=o((t$1,a)=>{t(t$1,a),a.setShowData(t$1.showData),t$1.sections.map(a.addSection);},"populateDb"),bt={parse:o(async t=>{let a=await d("pie",t);ct.debug(a),Tt(a,st);},"parse")},At=o(t=>`
  .pieCircle{
